...
![Overview of a global transaction](https://seata.apache.org/assets/images/TB1hSpccIVl614jSZKPXXaGjpXa-1330-924-7e6b5a4c3096ed800b0251a00de52dc7.png)

In this document, we will focus on the usage of Seata XA Mode. If you are interested in the principles behind XA Mode, please read the corresponding [Developer Guide](https://seata.apache.org/docs/dev/mode/xa-mode).
