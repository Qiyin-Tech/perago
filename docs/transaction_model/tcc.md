...
![Overview of a global transaction](https://seata.apache.org/assets/images/seata_tcc-1-1f7a834639aa755d73fa2af435c4f042.png)

In this document, we will focus on the usage of Seata TCC Mode. If you are interested in the principles behind TCC Mode and want to understand how Seata TCC addresses idempotence, empty rollback, and hanging issues, please refer to the corresponding [Developer Guide](https://seata.apache.org/docs/dev/mode/tcc-mode).
